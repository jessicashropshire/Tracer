...
from tracer.models.PETAL_dish_jess_4 import petal_dish
from tracer.models.Two_N_parameters_cavity_jess import TwoNparamcav
...
class DishScene(TracerScene):
    ...
    disp_num_rays = t_api.Int(50)# why an integer
